...
class TestPaymentMethodsMetadataGooglePay(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataGooglePay:
        """Test PaymentMethodsMetadataGooglePay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataGooglePay`
        """
        model = PaymentMethodsMetadataGooglePay()
        if include_optional:
