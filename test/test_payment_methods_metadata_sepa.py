...
class TestPaymentMethodsMetadataSepa(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataSepa:
        """Test PaymentMethodsMetadataSepa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataSepa`
        """
        model = PaymentMethodsMetadataSepa()
        if include_optional:
