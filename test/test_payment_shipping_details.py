...
class TestPaymentShippingDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentShippingDetails:
        """Test PaymentShippingDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentShippingDetails`
        """
        model = PaymentShippingDetails()
        if include_optional:
