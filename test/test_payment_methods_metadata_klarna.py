...
class TestPaymentMethodsMetadataKlarna(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataKlarna:
        """Test PaymentMethodsMetadataKlarna
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataKlarna`
        """
        model = PaymentMethodsMetadataKlarna()
        if include_optional:
