...
class TestPaymentPaymentMethodTrustly(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentPaymentMethodTrustly:
        """Test PaymentPaymentMethodTrustly
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentPaymentMethodTrustly`
        """
        model = PaymentPaymentMethodTrustly()
        if include_optional:
