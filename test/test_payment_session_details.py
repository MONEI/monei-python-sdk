...
class TestPaymentSessionDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentSessionDetails:
        """Test PaymentSessionDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentSessionDetails`
        """
        model = PaymentSessionDetails()
        if include_optional:
