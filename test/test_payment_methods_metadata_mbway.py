...
class TestPaymentMethodsMetadataMbway(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataMbway:
        """Test PaymentMethodsMetadataMbway
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataMbway`
        """
        model = PaymentMethodsMetadataMbway()
        if include_optional:
