...
class TestPaymentBillingDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentBillingDetails:
        """Test PaymentBillingDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentBillingDetails`
        """
        model = PaymentBillingDetails()
        if include_optional:
