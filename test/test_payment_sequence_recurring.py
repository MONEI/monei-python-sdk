...
class TestPaymentSequenceRecurring(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentSequenceRecurring:
        """Test PaymentSequenceRecurring
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentSequenceRecurring`
        """
        model = PaymentSequenceRecurring()
        if include_optional:
