...
class TestPaymentPaymentMethodKlarna(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentPaymentMethodKlarna:
        """Test PaymentPaymentMethodKlarna
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentPaymentMethodKlarna`
        """
        model = PaymentPaymentMethodKlarna()
        if include_optional:
