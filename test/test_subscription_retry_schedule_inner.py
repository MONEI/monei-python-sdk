...
class TestSubscriptionRetryScheduleInner(unittest.TestCase):
    """SubscriptionRetryScheduleInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionRetryScheduleInner:
        """Test SubscriptionRetryScheduleInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionRetryScheduleInner`
        """
        model = SubscriptionRetryScheduleInner()
        if include_optional:
            return SubscriptionRetryScheduleInner(
                interval = 'day',
                interval_count = 3
            )
        else:
    ...
    def testSubscriptionRetryScheduleInner(self):
        """Test SubscriptionRetryScheduleInner"""
