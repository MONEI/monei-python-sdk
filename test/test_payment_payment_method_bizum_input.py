...
class TestPaymentPaymentMethodBizumInput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentPaymentMethodBizumInput:
        """Test PaymentPaymentMethodBizumInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentPaymentMethodBizumInput`
        """
        model = PaymentPaymentMethodBizumInput()
        if include_optional:
