...
class TestSendSubscriptionLinkRequest(unittest.TestCase):
    """SendSubscriptionLinkRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendSubscriptionLinkRequest:
        """Test SendSubscriptionLinkRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSubscriptionLinkRequest`
        """
        model = SendSubscriptionLinkRequest()
        if include_optional:
            return SendSubscriptionLinkRequest(
                customer_email = '',
                customer_phone = '',
                channel = 'email',
                language = ''
    ...
    def testSendSubscriptionLinkRequest(self):
        """Test SendSubscriptionLinkRequest"""
