...
class TestPaymentMethodsMetadataAlipay(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataAlipay:
        """Test PaymentMethodsMetadataAlipay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataAlipay`
        """
        model = PaymentMethodsMetadataAlipay()
        if include_optional:
