...
class TestPaymentMethodsMetadataApplePay(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataApplePay:
        """Test PaymentMethodsMetadataApplePay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataApplePay`
        """
        model = PaymentMethodsMetadataApplePay()
        if include_optional:
