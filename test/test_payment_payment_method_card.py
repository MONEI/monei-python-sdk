...
class TestPaymentPaymentMethodCard(unittest.TestCase):
    """PaymentPaymentMethodCard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentPaymentMethodCard:
        """Test PaymentPaymentMethodCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentPaymentMethodCard`
        """
        model = PaymentPaymentMethodCard()
        if include_optional:
            return PaymentPaymentMethodCard(
                country = 'ES',
                brand = 'visa',
                type = 'credit',
    ...
    def testPaymentPaymentMethodCard(self):
        """Test PaymentPaymentMethodCard"""
