...
class TestPaymentMethodsMetadata(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadata:
        """Test PaymentMethodsMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadata`
        """
        model = PaymentMethodsMetadata()
        if include_optional:
