...
class TestSubscriptionPaymentMethodCard(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SubscriptionPaymentMethodCard:
        """Test SubscriptionPaymentMethodCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionPaymentMethodCard`
        """
        model = SubscriptionPaymentMethodCard()
        if include_optional:
