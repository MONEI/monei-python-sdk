...
class TestPaymentMethodsMetadataGiropay(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataGiropay:
        """Test PaymentMethodsMetadataGiropay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataGiropay`
        """
        model = PaymentMethodsMetadataGiropay()
        if include_optional:
