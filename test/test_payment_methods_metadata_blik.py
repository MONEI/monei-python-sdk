...
class TestPaymentMethodsMetadataBlik(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataBlik:
        """Test PaymentMethodsMetadataBlik
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataBlik`
        """
        model = PaymentMethodsMetadataBlik()
        if include_optional:
