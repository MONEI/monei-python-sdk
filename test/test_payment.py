        ...
        if include_optional:
            return Payment(
                ...
                customer = Monei.models.payment_customer.Payment-Customer(
                    ...
                    name = 'John Doe', 
                    phone = '', ),
                shop = Monei.models.payment_shop.Payment-Shop(
                    name = 'Test Shop', 
                    country = 'ES', ),
                ...
                payment_method = Monei.models.payment_payment_method.Payment-PaymentMethod(
                    method = 'card', 
                    ...
                    bizum = Monei.models.payment_payment_method_bizum.Payment-PaymentMethodBizum(
                        phone_number = '', ), 
                    paypal = Monei.models.payment_payment_method_paypal.Payment-PaymentMethodPaypal(
                        order_id = '', ), 
                    cofidis = Monei.models.payment_payment_method_cofidis.Payment-PaymentMethodCofidis(
                        order_id = '', ), 
                    cofidis_loan = Monei.models.payment_payment_method_cofidis.Payment-PaymentMethodCofidis(
                        order_id = '', ), 
                    mbway = Monei.models.payment_payment_method_mbway.Payment-PaymentMethodMbway(
                        phone_number = '', ), 
                    trustly = Monei.models.payment_payment_method_trustly.Payment-PaymentMethodTrustly(
                        customer_id = '', ), 
                    sepa = Monei.models.payment_payment_method_sepa.Payment-PaymentMethodSepa(
                        ...
                        bic = '', 
                        last4 = '', ), 
                    klarna = Monei.models.payment_payment_method_klarna.Payment-PaymentMethodKlarna(
                ...
                next_action = Monei.models.payment_next_action.Payment-NextAction(
                    type = 'CONFIRM', 
                    must_redirect = False, 
