...
class TestConfirmPaymentRequestPaymentMethodCard(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConfirmPaymentRequestPaymentMethodCard:
        """Test ConfirmPaymentRequestPaymentMethodCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfirmPaymentRequestPaymentMethodCard`
        """
        model = ConfirmPaymentRequestPaymentMethodCard()
        if include_optional:
