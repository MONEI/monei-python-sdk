...
class TestPaymentMethodsMetadataIDeal(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataIDeal:
        """Test PaymentMethodsMetadataIDeal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataIDeal`
        """
        model = PaymentMethodsMetadataIDeal()
        if include_optional:
