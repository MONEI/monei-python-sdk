...
class TestSendPaymentLinkRequest(unittest.TestCase):
    """SendPaymentLinkRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPaymentLinkRequest:
        """Test SendPaymentLinkRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPaymentLinkRequest`
        """
    ...
    def testSendPaymentLinkRequest(self):
        """Test SendPaymentLinkRequest"""
