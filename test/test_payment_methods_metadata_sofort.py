...
class TestPaymentMethodsMetadataSofort(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataSofort:
        """Test PaymentMethodsMetadataSofort
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataSofort`
        """
        model = PaymentMethodsMetadataSofort()
        if include_optional:
