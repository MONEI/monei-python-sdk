...
class TestPaymentMethodsMetadataClickToPayMastercard(unittest.TestCase):
    """PaymentMethodsMetadataClickToPayMastercard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataClickToPayMastercard:
        """Test PaymentMethodsMetadataClickToPayMastercard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataClickToPayMastercard`
        """
        model = PaymentMethodsMetadataClickToPayMastercard()
        if include_optional:
            return PaymentMethodsMetadataClickToPayMastercard(
    ...
    def testPaymentMethodsMetadataClickToPayMastercard(self):
        """Test PaymentMethodsMetadataClickToPayMastercard"""
