...
class TestPaymentMethodsMetadataBancontact(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataBancontact:
        """Test PaymentMethodsMetadataBancontact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataBancontact`
        """
        model = PaymentMethodsMetadataBancontact()
        if include_optional:
