...
class TestSubscriptionLastPayment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SubscriptionLastPayment:
        """Test SubscriptionLastPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionLastPayment`
        """
        model = SubscriptionLastPayment()
        if include_optional:
