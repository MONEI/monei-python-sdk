...
class TestValidateBizumPhoneRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ValidateBizumPhoneRequest:
        """Test ValidateBizumPhoneRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidateBizumPhoneRequest`
        """
        model = ValidateBizumPhoneRequest()
        if include_optional:
