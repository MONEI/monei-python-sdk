...
class TestConfirmPaymentRequestPaymentMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConfirmPaymentRequestPaymentMethod:
        """Test ConfirmPaymentRequestPaymentMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfirmPaymentRequestPaymentMethod`
        """
        model = ConfirmPaymentRequestPaymentMethod()
        if include_optional:
