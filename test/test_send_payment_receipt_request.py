...
class TestSendPaymentReceiptRequest(unittest.TestCase):
    """SendPaymentReceiptRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPaymentReceiptRequest:
        """Test SendPaymentReceiptRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPaymentReceiptRequest`
        """
        model = SendPaymentReceiptRequest()
        if include_optional:
            return SendPaymentReceiptRequest(
                customer_email = 'john.doe@example.com',
                customer_phone = '+34500000000',
                channel = 'EMAIL',
                language = 'en'
            )
        else:
    ...
    def testSendPaymentReceiptRequest(self):
        """Test SendPaymentReceiptRequest"""
