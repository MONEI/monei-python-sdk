...
class TestPaymentMethodsMetadataCard(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataCard:
        """Test PaymentMethodsMetadataCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataCard`
        """
        model = PaymentMethodsMetadataCard()
        if include_optional:
