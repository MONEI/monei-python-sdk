...
class TestPaymentNextAction(unittest.TestCase):
    """PaymentNextAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentNextAction:
        """Test PaymentNextAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentNextAction`
        """
        model = PaymentNextAction()
        if include_optional:
    ...
    def testPaymentNextAction(self):
        """Test PaymentNextAction"""
