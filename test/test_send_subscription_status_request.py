...
class TestSendSubscriptionStatusRequest(unittest.TestCase):
    """SendSubscriptionStatusRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendSubscriptionStatusRequest:
        """Test SendSubscriptionStatusRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSubscriptionStatusRequest`
        """
        model = SendSubscriptionStatusRequest()
        if include_optional:
            return SendSubscriptionStatusRequest(
                customer_email = '',
                customer_phone = '',
                channel = 'email',
                language = ''
    ...
    def testSendSubscriptionStatusRequest(self):
        """Test SendSubscriptionStatusRequest"""
