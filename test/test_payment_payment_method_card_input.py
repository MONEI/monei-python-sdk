...
class TestPaymentPaymentMethodCardInput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentPaymentMethodCardInput:
        """Test PaymentPaymentMethodCardInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentPaymentMethodCardInput`
        """
        model = PaymentPaymentMethodCardInput()
        if include_optional:
