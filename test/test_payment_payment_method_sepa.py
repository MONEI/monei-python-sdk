...
class TestPaymentPaymentMethodSepa(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentPaymentMethodSepa:
        """Test PaymentPaymentMethodSepa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentPaymentMethodSepa`
        """
        model = PaymentPaymentMethodSepa()
        if include_optional:
