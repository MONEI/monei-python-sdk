...
class TestPaymentMethodsMetadataClickToPayDiscover(unittest.TestCase):
    """PaymentMethodsMetadataClickToPayDiscover unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataClickToPayDiscover:
        """Test PaymentMethodsMetadataClickToPayDiscover
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataClickToPayDiscover`
        """
        model = PaymentMethodsMetadataClickToPayDiscover()
        if include_optional:
            return PaymentMethodsMetadataClickToPayDiscover(
    ...
    def testPaymentMethodsMetadataClickToPayDiscover(self):
        """Test PaymentMethodsMetadataClickToPayDiscover"""
