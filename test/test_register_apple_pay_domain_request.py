...
class TestRegisterApplePayDomainRequest(unittest.TestCase):
    """RegisterApplePayDomainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterApplePayDomainRequest:
        """Test RegisterApplePayDomainRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegisterApplePayDomainRequest`
        """
        model = RegisterApplePayDomainRequest()
        if include_optional:
            return RegisterApplePayDomainRequest(
    ...
    def testRegisterApplePayDomainRequest(self):
        """Test RegisterApplePayDomainRequest"""
