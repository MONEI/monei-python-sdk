...
class TestPaymentMethods(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethods:
        """Test PaymentMethods
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethods`
        """
        model = PaymentMethods()
        if include_optional:
            return PaymentMethods(
                livemode = False,
                payment_methods = ["bizum","applePay","googlePay","alipay","bancontact","blik","cofidis","cofidisLoan","eps","iDeal","mbway","multibanco","sofort","trustly","sepa","klarna","giropay","card"],
                metadata = Monei.models.payment_methods_metadata.PaymentMethods-Metadata(
