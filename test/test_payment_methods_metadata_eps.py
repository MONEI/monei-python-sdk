...
class TestPaymentMethodsMetadataEps(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataEps:
        """Test PaymentMethodsMetadataEps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataEps`
        """
        model = PaymentMethodsMetadataEps()
        if include_optional:
