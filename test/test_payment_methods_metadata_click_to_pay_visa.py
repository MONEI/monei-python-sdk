...
class TestPaymentMethodsMetadataClickToPayVisa(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataClickToPayVisa:
        """Test PaymentMethodsMetadataClickToPayVisa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataClickToPayVisa`
        """
        model = PaymentMethodsMetadataClickToPayVisa()
        if include_optional:
            return PaymentMethodsMetadataClickToPayVisa(
