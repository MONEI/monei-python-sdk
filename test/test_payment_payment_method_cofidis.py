...
class TestPaymentPaymentMethodCofidis(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentPaymentMethodCofidis:
        """Test PaymentPaymentMethodCofidis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentPaymentMethodCofidis`
        """
        model = PaymentPaymentMethodCofidis()
        if include_optional:
