...
import Monei
from Monei.models.payment_payment_method_cofidis import PaymentPaymentMethodCofidis  # noqa: E501
from Monei.rest import ApiException

class TestPaymentPaymentMethodCofidis(unittest.TestCase):
    """PaymentPaymentMethodCofidis unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = Monei.models.payment_payment_method_cofidis.PaymentPaymentMethodCofidis()  # noqa: E501
        if include_optional :
            return PaymentPaymentMethodCofidis(
                order_id = '0'
            )
        else :
            return PaymentPaymentMethodCofidis(
