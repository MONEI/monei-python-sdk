...
class TestPaymentMethodsMetadataTrustly(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodsMetadataTrustly:
        """Test PaymentMethodsMetadataTrustly
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodsMetadataTrustly`
        """
        model = PaymentMethodsMetadataTrustly()
        if include_optional:
