...
class TestPaymentPaymentMethodInput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentPaymentMethodInput:
        """Test PaymentPaymentMethodInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentPaymentMethodInput`
        """
        model = PaymentPaymentMethodInput()
        if include_optional:
