...
class TestBizumValidatePhone200Response(unittest.TestCase):
    """BizumValidatePhone200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BizumValidatePhone200Response:
        """Test BizumValidatePhone200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BizumValidatePhone200Response`
        """
        model = BizumValidatePhone200Response()
        if include_optional:
            return BizumValidatePhone200Response(
                is_valid = True
            )
        else:
            return BizumValidatePhone200Response(
    ...
    def testBizumValidatePhone200Response(self):
        """Test BizumValidatePhone200Response"""
