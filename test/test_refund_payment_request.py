...
from MONEI PYTHON SDK.models.refund_payment_request import RefundPaymentRequest  # noqa: E501
...
class TestRefundPaymentRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = MONEI PYTHON SDK.models.refund_payment_request.RefundPaymentRequest()  # noqa: E501
        if include_optional :
            return RefundPaymentRequest(
                amount = null, 
                refund_reason = 'duplicated'
            )
        else :
            return RefundPaymentRequest(
        )
