...
class SubscriptionsApi(object):
    ...
    def activate(self, id, **kwargs):  # noqa: E501
        ...
        :param str id: The subscription ID (required)
        :param ActivateSubscriptionRequest activate_subscription_request:
        ...
        return self.activate_with_http_info(id, **kwargs)  # noqa: E501

    def activate_with_http_info(self, id, **kwargs):  # noqa: E501
        """Activate Subscription  # noqa: E501

        Activates the subscription that was previously created. Activation of the subscription will create an initial payment. If the subscription has trial period, the initial payment will have zero amount. The subscription is automatically activated when initial payment is confirmed.  If the subscription is already activated, this endpoint can be used to update payment method. This will also generate zero amount payment.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activate_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `activate`")  # noqa: E501
        ...
        body_params = None
        if 'activate_subscription_request' in local_var_params:
            body_params = local_var_params['activate_subscription_request']
        # HTTP header `Accept`
    ...
    def cancel(self, id, **kwargs):  # noqa: E501
        ...
        Cancels the activate subscription.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param str id: The subscription ID (required)
        :param CancelSubscriptionRequest cancel_subscription_request:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def cancel_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'cancel_subscription_request' in local_var_params:
            body_params = local_var_params['cancel_subscription_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def create(self, create_subscription_request, **kwargs):  # noqa: E501
        """Create Subscription  # noqa: E501

        Creates a new subscription. Subscription is created with status: `PENDING`. In order to activate it you need to call [activate endpoint](#operation/subscriptions_activate).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def create_with_http_info(self, create_subscription_request, **kwargs):  # noqa: E501
        """Create Subscription  # noqa: E501

        Creates a new subscription. Subscription is created with status: `PENDING`. In order to activate it you need to call [activate endpoint](#operation/subscriptions_activate).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(create_subscription_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('create_subscription_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['create_subscription_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `create_subscription_request` when calling `create`")  # noqa: E501
        ...
        body_params = None
        if 'create_subscription_request' in local_var_params:
            body_params = local_var_params['create_subscription_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def get(self, id, **kwargs):  # noqa: E501
        ...
        Get the details of a subscription that has previously been created. Supply the unique subscription ID that was returned from your previous request.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def pause(self, id, **kwargs):  # noqa: E501
        """Pause Subscription  # noqa: E501

        Pauses the active subscription.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param str id: The subscription ID (required)
        :param PauseSubscriptionRequest pause_subscription_request:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def pause_with_http_info(self, id, **kwargs):  # noqa: E501
        """Pause Subscription  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `pause`")  # noqa: E501
        ...
        body_params = None
        if 'pause_subscription_request' in local_var_params:
            body_params = local_var_params['pause_subscription_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def resume(self, id, **kwargs):  # noqa: E501
        ...
        Resumes the paused subscription.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update(self, id, update_subscription_request, **kwargs):  # noqa: E501
        """Update Subscription  # noqa: E501

        Updates an existing subscription. Supply the unique subscription ID that was returned from your previous request.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_with_http_info(id, update_subscription_request, **kwargs)  # noqa: E501

    def update_with_http_info(self, id, update_subscription_request, **kwargs):  # noqa: E501
        """Update Subscription  # noqa: E501

        Updates an existing subscription. Supply the unique subscription ID that was returned from your previous request.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_with_http_info(id, update_subscription_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('update_subscription_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['update_subscription_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `update_subscription_request` when calling `update`")  # noqa: E501
        ...
        body_params = None
        if 'update_subscription_request' in local_var_params:
            body_params = local_var_params['update_subscription_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
