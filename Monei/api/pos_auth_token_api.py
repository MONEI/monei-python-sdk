...
class POSAuthTokenApi(object):
    ...
    def create(self, create_pos_auth_token_request, **kwargs):
        ...
        >>> thread = api.create(create_pos_auth_token_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["create_pos_auth_token_request"] = create_pos_auth_token_request
