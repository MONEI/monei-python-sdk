...
class RegisterApplePayDomainRequest(BaseModel):
    ...
    """ # noqa: E501
    domain_name: StrictStr = Field(description="The domain name to register for Apple Pay.", alias="domainName")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegisterApplePayDomainRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegisterApplePayDomainRequest from a dict"""
        if obj is None:
            return None
