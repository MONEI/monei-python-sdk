...
class Error(BaseModel):
    ...
    Error
    """ # noqa: E501
    status: StrictStr = Field(description="Error type identifier")
    ...
    request_time: datetime = Field(description="Timestamp when the request was processed", alias="requestTime")
    __properties: ClassVar[List[str]] = ["status", "statusCode", "message", "requestId", "requestTime"]
