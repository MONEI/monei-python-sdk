...
class ValidateBizumPhoneRequest(BaseModel):
    """
    ValidateBizumPhoneRequest
    """ # noqa: E501
    account_id: StrictStr = Field(description="MONEI Account identifier.", alias="accountId")
    payment_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the payment.", alias="paymentId")
    phone_number: StrictStr = Field(description="Phone number in E.164 format.", alias="phoneNumber")
    __properties: ClassVar[List[str]] = ["accountId", "paymentId", "phoneNumber"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidateBizumPhoneRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidateBizumPhoneRequest from a dict"""
        if obj is None:
            return None
