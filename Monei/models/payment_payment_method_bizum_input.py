...
class PaymentPaymentMethodBizumInput(BaseModel):
    """
    ...
    """ # noqa: E501
    phone_number: Optional[StrictStr] = Field(default=None, description="Phone number in E.164 format used to pay with `bizum`.", alias="phoneNumber")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentPaymentMethodBizumInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentPaymentMethodBizumInput from a dict"""
        if obj is None:
            return None
