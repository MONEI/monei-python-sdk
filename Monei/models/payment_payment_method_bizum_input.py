...
class PaymentPaymentMethodBizumInput(object):
    ...
    def __init__(self, phone_number=None, local_vars_configuration=None):  # noqa: E501
        """PaymentPaymentMethodBizumInput - a model defined in OpenAPI"""  # noqa: E501
    ...
    def phone_number(self):
        """Gets the phone_number of this PaymentPaymentMethodBizumInput.  # noqa: E501

        Phone number in E.164 format used to pay with `bizum`.  # noqa: E501

        :return: The phone_number of this PaymentPaymentMethodBizumInput.  # noqa: E501
        :rtype: str
        """
    ...
    def phone_number(self, phone_number):
        """Sets the phone_number of this PaymentPaymentMethodBizumInput.

        Phone number in E.164 format used to pay with `bizum`.  # noqa: E501

        :param phone_number: The phone_number of this PaymentPaymentMethodBizumInput.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaymentPaymentMethodBizumInput):
            return False
