...
class UpdateSubscriptionRequest(object):
    ...
    def __init__(self, amount=None, interval=None, interval_count=None, description=None, customer=None, billing_details=None, shipping_details=None, trial_period_end=None, callback_url=None, payment_callback_url=None, pause_at_period_end=None, cancel_at_period_end=None, pause_interval_count=None, retry_schedule=None, metadata=None, local_vars_configuration=None):  # noqa: E501
    ...
    def retry_schedule(self):
        """Gets the retry_schedule of this UpdateSubscriptionRequest.  # noqa: E501
        ...
        :return: The retry_schedule of this UpdateSubscriptionRequest.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def retry_schedule(self, retry_schedule):
        """Sets the retry_schedule of this UpdateSubscriptionRequest.

        Defines a custom schedule for retrying failed subscription payments. Each entry in the array specifies how long to wait before attempting the next payment retry. If not specified, the system's default retry schedule will be used.   # noqa: E501

        :param retry_schedule: The retry_schedule of this UpdateSubscriptionRequest.  # noqa: E501
        :type: list[object]
        """
    ...
    @property
    def metadata(self):
        """Gets the metadata of this UpdateSubscriptionRequest.  # noqa: E501
        ...
        :return: The metadata of this UpdateSubscriptionRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def metadata(self, metadata):
        """Sets the metadata of this UpdateSubscriptionRequest.

        A set of key-value pairs that you can attach to a resource. This can be useful for storing additional information about the resource in a structured format.  # noqa: E501

        :param metadata: The metadata of this UpdateSubscriptionRequest.  # noqa: E501
        :type: object
        """
