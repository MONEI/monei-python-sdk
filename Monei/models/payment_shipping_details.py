...
class PaymentShippingDetails(BaseModel):
    """
    Shipping information associated with the payment.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The shipping customer's full name.")
    email: Optional[StrictStr] = Field(default=None, description="The shipping customer's email address.")
    phone: Optional[StrictStr] = Field(default=None, description="The shipping customer's phone number in E.164 format.")
    company: Optional[StrictStr] = Field(default=None, description="Name of the company where the shipment is going.")
    tax_id: Optional[StrictStr] = Field(default=None, description="Company tax ID.", alias="taxId")
    address: Optional[Address] = None
    __properties: ClassVar[List[str]] = ["name", "email", "phone", "company", "taxId", "address"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentShippingDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentShippingDetails from a dict"""
        if obj is None:
            return None
