...
class PaymentPaymentMethodCofidis(BaseModel):
    """
    Details from Cofidis order used as payment method at the time of the transaction. 
    """ # noqa: E501
    order_id: Optional[StrictStr] = Field(default=None, description="The Cofidis' order ID.", alias="orderId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentPaymentMethodCofidis from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentPaymentMethodCofidis from a dict"""
        if obj is None:
            return None
