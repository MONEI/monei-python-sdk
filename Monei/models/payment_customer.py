...
class PaymentCustomer(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The customer's full name or business name.")
    phone: Optional[StrictStr] = Field(default=None, description="The customer's phone number in E.164 format.")
