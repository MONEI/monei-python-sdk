...
class SubscriptionRetryScheduleInner(BaseModel):
    """
    SubscriptionRetryScheduleInner
    """ # noqa: E501
    interval: StrictStr = Field(description="The unit of time to wait before the retry attempt.")
    interval_count: Annotated[int, Field(le=31, strict=True, ge=1)] = Field(description="The number of intervals to wait before the retry attempt.", alias="intervalCount")
    __properties: ClassVar[List[str]] = ["interval", "intervalCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionRetryScheduleInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionRetryScheduleInner from a dict"""
        if obj is None:
            return None
