...
class SendPaymentReceiptRequest(BaseModel):
    ...
    """ # noqa: E501
    customer_email: Optional[StrictStr] = Field(default=None, description="The customer will receive payment receipt on this email address.", alias="customerEmail")
    customer_phone: Optional[StrictStr] = Field(default=None, description="Phone number in E.164 format. The customer will receive payment receipt link on this phone number.", alias="customerPhone")
    channel: Optional[PaymentMessageChannel] = None
    language: Optional[PaymentMessageLanguage] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SendPaymentReceiptRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SendPaymentReceiptRequest from a dict"""
        if obj is None:
            return None
