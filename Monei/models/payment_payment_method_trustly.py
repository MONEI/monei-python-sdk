...
class PaymentPaymentMethodTrustly(BaseModel):
    """
    Details from Trustly order used as payment method at the time of the transaction. 
    """ # noqa: E501
    customer_id: Optional[StrictStr] = Field(default=None, description="The Trustly's customer ID.", alias="customerId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentPaymentMethodTrustly from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentPaymentMethodTrustly from a dict"""
        if obj is None:
            return None
