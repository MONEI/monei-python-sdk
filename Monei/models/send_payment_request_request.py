...
class SendPaymentRequestRequest(BaseModel):
    ...
    """ # noqa: E501
    phone_number: StrictStr = Field(description="Phone number in E.164 format. The customer will receive payment link on this phone number.", alias="phoneNumber")
    language: Optional[PaymentMessageLanguage] = None
    __properties: ClassVar[List[str]] = ["phoneNumber", "language"]
