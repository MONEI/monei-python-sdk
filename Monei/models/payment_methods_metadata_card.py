...
class PaymentMethodsMetadataCard(BaseModel):
    """
    PaymentMethodsMetadataCard
    """ # noqa: E501
    brands: Optional[List[StrictStr]] = Field(default=None, description="List of card brands supported")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentMethodsMetadataCard from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentMethodsMetadataCard from a dict"""
        if obj is None:
            return None
