...
class SendSubscriptionStatusRequest(object):
    ...
    def __init__(self, customer_email=None, customer_phone=None, channel=None, language=None, local_vars_configuration=None):  # noqa: E501
        """SendSubscriptionStatusRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def customer_email(self):
        """Gets the customer_email of this SendSubscriptionStatusRequest.  # noqa: E501

        Customer email to send the subscription status to  # noqa: E501

        :return: The customer_email of this SendSubscriptionStatusRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def customer_email(self, customer_email):
        """Sets the customer_email of this SendSubscriptionStatusRequest.

        Customer email to send the subscription status to  # noqa: E501

        :param customer_email: The customer_email of this SendSubscriptionStatusRequest.  # noqa: E501
        :type: str
        """
    ...
    def customer_phone(self):
        """Gets the customer_phone of this SendSubscriptionStatusRequest.  # noqa: E501

        Customer phone number to send the subscription status to  # noqa: E501

        :return: The customer_phone of this SendSubscriptionStatusRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def customer_phone(self, customer_phone):
        """Sets the customer_phone of this SendSubscriptionStatusRequest.

        Customer phone number to send the subscription status to  # noqa: E501

        :param customer_phone: The customer_phone of this SendSubscriptionStatusRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def channel(self):
        """Gets the channel of this SendSubscriptionStatusRequest.  # noqa: E501

        Channel to use for sending the subscription status  # noqa: E501

        :return: The channel of this SendSubscriptionStatusRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this SendSubscriptionStatusRequest.

        Channel to use for sending the subscription status  # noqa: E501

        :param channel: The channel of this SendSubscriptionStatusRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def language(self):
        """Gets the language of this SendSubscriptionStatusRequest.  # noqa: E501

        Language to use for the subscription status message  # noqa: E501

        :return: The language of this SendSubscriptionStatusRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def language(self, language):
        """Sets the language of this SendSubscriptionStatusRequest.

        Language to use for the subscription status message  # noqa: E501

        :param language: The language of this SendSubscriptionStatusRequest.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SendSubscriptionStatusRequest):
            return False
