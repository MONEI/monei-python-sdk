...
class SendSubscriptionStatusRequest(BaseModel):
    """
    SendSubscriptionStatusRequest
    """ # noqa: E501
    customer_email: Optional[StrictStr] = Field(default=None, description="Customer email to send the subscription status to", alias="customerEmail")
    customer_phone: Optional[StrictStr] = Field(default=None, description="Customer phone number to send the subscription status to", alias="customerPhone")
    channel: Optional[StrictStr] = Field(default=None, description="Channel to use for sending the subscription status")
    language: Optional[StrictStr] = Field(default=None, description="Language to use for the subscription status message")
    __properties: ClassVar[List[str]] = ["customerEmail", "customerPhone", "channel", "language"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SendSubscriptionStatusRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SendSubscriptionStatusRequest from a dict"""
        if obj is None:
            return None
