...
class PaymentNextAction(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['CONFIRM', 'CHALLENGE', 'FRICTIONLESS_CHALLENGE', 'BIZUM_CHALLENGE', 'COMPLETE']):
            raise ValueError("must be one of enum values ('CONFIRM', 'CHALLENGE', 'FRICTIONLESS_CHALLENGE', 'BIZUM_CHALLENGE', 'COMPLETE')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentNextAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentNextAction from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "mustRedirect": obj.get("mustRedirect"),
