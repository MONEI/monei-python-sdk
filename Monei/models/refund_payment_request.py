...
class RefundPaymentRequest(BaseModel):
    ...
    """ # noqa: E501
    amount: Optional[StrictInt] = Field(default=None, description="The amount to refund, which must be less than or equal to the original amount. ")
    refund_reason: Optional[PaymentRefundReason] = Field(default=None, alias="refundReason")
    __properties: ClassVar[List[str]] = ["amount", "refundReason"]
