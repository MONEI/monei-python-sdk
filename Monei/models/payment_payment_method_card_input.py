...
class PaymentPaymentMethodCardInput(BaseModel):
    """
    Details about the card used as payment method. If provided, MONEI will try to confirm the payment directly. 
    """ # noqa: E501
    number: Optional[StrictStr] = Field(default=None, description="The card number, as a string without any separators.")
    cvc: Optional[StrictStr] = Field(default=None, description="Card security code.")
    exp_month: Optional[StrictStr] = Field(default=None, description="Two-digit number representing the card's expiration month.", alias="expMonth")
    exp_year: Optional[StrictStr] = Field(default=None, description="Two-digit number representing the card's expiration year.", alias="expYear")
    cardholder_name: Optional[StrictStr] = Field(default=None, description="The cardholder's name, as stated in the credit card.", alias="cardholderName")
    cardholder_email: Optional[StrictStr] = Field(default=None, description="The cardholder's email address.", alias="cardholderEmail")
    __properties: ClassVar[List[str]] = ["number", "cvc", "expMonth", "expYear", "cardholderName", "cardholderEmail"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentPaymentMethodCardInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentPaymentMethodCardInput from a dict"""
        if obj is None:
            return None
