...
class PaymentSessionDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ip", "countryCode", "lang", "deviceType", "deviceModel", "browser", "browserVersion", "os", "osVersion", "source", "sourceVersion", "userAgent", "browserAccept", "browserColorDepth", "browserScreenHeight", "browserScreenWidth", "browserTimezoneOffset"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentSessionDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentSessionDetails from a dict"""
        if obj is None:
            return None
