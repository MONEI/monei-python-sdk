...
class PaymentMethodsMetadataGooglePay(BaseModel):
    """
    PaymentMethodsMetadataGooglePay
    """ # noqa: E501
    merchant_id: Optional[StrictStr] = Field(default=None, description="Google Pay merchant ID", alias="merchantId")
    cvc_required: Optional[StrictBool] = Field(default=None, description="Whether CVC is required for Google Pay transactions", alias="cvcRequired")
    __properties: ClassVar[List[str]] = ["merchantId", "cvcRequired"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentMethodsMetadataGooglePay from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentMethodsMetadataGooglePay from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "cvcRequired": obj.get("cvcRequired")
        })
        return _obj
