...
class PaymentMethodsMetadataBancontact(BaseModel):
    """
    PaymentMethodsMetadataBancontact
    """ # noqa: E501
    countries: Optional[List[StrictStr]] = Field(default=None, description="List of countries where the payment method is available")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentMethodsMetadataBancontact from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentMethodsMetadataBancontact from a dict"""
        if obj is None:
            return None
