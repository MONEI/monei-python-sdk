...
class SendSubscriptionLinkRequest(BaseModel):
    """
    SendSubscriptionLinkRequest
    """ # noqa: E501
    customer_email: Optional[StrictStr] = Field(default=None, description="Customer email to send the subscription link to", alias="customerEmail")
    customer_phone: Optional[StrictStr] = Field(default=None, description="Customer phone number to send the subscription link to", alias="customerPhone")
    channel: Optional[StrictStr] = Field(default=None, description="Channel to use for sending the subscription link")
    language: Optional[StrictStr] = Field(default=None, description="Language to use for the subscription link message")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SendSubscriptionLinkRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SendSubscriptionLinkRequest from a dict"""
        if obj is None:
            return None
