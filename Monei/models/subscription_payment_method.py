...
class SubscriptionPaymentMethod(BaseModel):
    """
    Details about the payment method at the time of the transaction. 
    """ # noqa: E501
    method: Optional[StrictStr] = Field(default=None, description="Subscription method type.")
    card: Optional[PaymentPaymentMethodCard] = None
    __properties: ClassVar[List[str]] = ["method", "card"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionPaymentMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionPaymentMethod from a dict"""
        if obj is None:
            return None
