...
class ConfirmPaymentRequestPaymentMethod(object):
    ...
    def __init__(self, card=None, local_vars_configuration=None):  # noqa: E501
        """ConfirmPaymentRequestPaymentMethod - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def card(self):
        """Gets the card of this ConfirmPaymentRequestPaymentMethod.  # noqa: E501


        :return: The card of this ConfirmPaymentRequestPaymentMethod.  # noqa: E501
        :rtype: ConfirmPaymentRequestPaymentMethodCard
        """
        return self._card

    @card.setter
    def card(self, card):
        """Sets the card of this ConfirmPaymentRequestPaymentMethod.


        :param card: The card of this ConfirmPaymentRequestPaymentMethod.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfirmPaymentRequestPaymentMethod):
            return False
