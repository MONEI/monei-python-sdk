...
class PaymentPaymentMethodSepa(BaseModel):
    """
    Details from SEPA order used as payment method at the time of the transaction. 
    """ # noqa: E501
    accountholder_address: Optional[StrictStr] = Field(default=None, description="The address of the account holder.", alias="accountholderAddress")
    accountholder_email: Optional[StrictStr] = Field(default=None, description="The email of the account holder.", alias="accountholderEmail")
    accountholder_name: Optional[StrictStr] = Field(default=None, description="The name of the account holder.", alias="accountholderName")
    country_code: Optional[StrictStr] = Field(default=None, description="The country code of the account holder.", alias="countryCode")
    bank_address: Optional[StrictStr] = Field(default=None, description="The address of the bank.", alias="bankAddress")
    bank_code: Optional[StrictStr] = Field(default=None, description="The code of the bank.", alias="bankCode")
    bank_name: Optional[StrictStr] = Field(default=None, description="The name of the bank.", alias="bankName")
    bic: Optional[StrictStr] = Field(default=None, description="The BIC of the bank.")
    last4: Optional[StrictStr] = Field(default=None, description="The last 4 digits of the IBAN.")
    __properties: ClassVar[List[str]] = ["accountholderAddress", "accountholderEmail", "accountholderName", "countryCode", "bankAddress", "bankCode", "bankName", "bic", "last4"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentPaymentMethodSepa from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentPaymentMethodSepa from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "accountholderEmail": obj.get("accountholderEmail"),
