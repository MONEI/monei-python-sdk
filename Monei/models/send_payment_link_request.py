...
class SendPaymentLinkRequest(BaseModel):
    ...
    """ # noqa: E501
    customer_email: Optional[StrictStr] = Field(default=None, description="The customer will receive payment link on this email address.", alias="customerEmail")
    customer_phone: Optional[StrictStr] = Field(default=None, description="Phone number in E.164 format. The customer will receive payment link on this phone number.", alias="customerPhone")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SendPaymentLinkRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SendPaymentLinkRequest from a dict"""
        if obj is None:
            return None
