...
class PaymentPaymentMethodMbway(BaseModel):
    """
    Details from MBWay order used as payment method at the time of the transaction. 
    """ # noqa: E501
    phone_number: Optional[StrictStr] = Field(default=None, description="Phone number in E.164 format used to pay with `mbway`.", alias="phoneNumber")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentPaymentMethodMbway from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentPaymentMethodMbway from a dict"""
        if obj is None:
            return None
