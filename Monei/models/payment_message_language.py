...
class PaymentMessageLanguage(object):
    ...
    allowable_values = [EN, ES, CA, PT, DE, IT, FR]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """PaymentMessageLanguage - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaymentMessageLanguage):
            return False
