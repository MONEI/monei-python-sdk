...
class PaymentMethodsMetadataClickToPayMastercard(object):
    ...
    def __init__(self, srci_dpa_id=None, src_initiator_id=None, local_vars_configuration=None):  # noqa: E501
        """PaymentMethodsMetadataClickToPayMastercard - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._srci_dpa_id = None
        self._src_initiator_id = None
        self.discriminator = None

        if srci_dpa_id is not None:
            self.srci_dpa_id = srci_dpa_id
        if src_initiator_id is not None:
            self.src_initiator_id = src_initiator_id

    @property
    def srci_dpa_id(self):
        """Gets the srci_dpa_id of this PaymentMethodsMetadataClickToPayMastercard.  # noqa: E501


        :return: The srci_dpa_id of this PaymentMethodsMetadataClickToPayMastercard.  # noqa: E501
        :rtype: str
        """
        return self._srci_dpa_id

    @srci_dpa_id.setter
    def srci_dpa_id(self, srci_dpa_id):
        """Sets the srci_dpa_id of this PaymentMethodsMetadataClickToPayMastercard.


        :param srci_dpa_id: The srci_dpa_id of this PaymentMethodsMetadataClickToPayMastercard.  # noqa: E501
        :type: str
        """

        self._srci_dpa_id = srci_dpa_id

    @property
    def src_initiator_id(self):
        """Gets the src_initiator_id of this PaymentMethodsMetadataClickToPayMastercard.  # noqa: E501


        :return: The src_initiator_id of this PaymentMethodsMetadataClickToPayMastercard.  # noqa: E501
        :rtype: str
        """
        return self._src_initiator_id

    @src_initiator_id.setter
    def src_initiator_id(self, src_initiator_id):
        """Sets the src_initiator_id of this PaymentMethodsMetadataClickToPayMastercard.


        :param src_initiator_id: The src_initiator_id of this PaymentMethodsMetadataClickToPayMastercard.  # noqa: E501
        :type: str
        """

        self._src_initiator_id = src_initiator_id
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaymentMethodsMetadataClickToPayMastercard):
            return False
