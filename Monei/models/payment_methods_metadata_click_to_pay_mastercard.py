...
class PaymentMethodsMetadataClickToPayMastercard(BaseModel):
    """
    PaymentMethodsMetadataClickToPayMastercard
    """ # noqa: E501
    srci_dpa_id: Optional[StrictStr] = Field(default=None, alias="srciDpaId")
    src_initiator_id: Optional[StrictStr] = Field(default=None, alias="srcInitiatorId")
    __properties: ClassVar[List[str]] = ["srciDpaId", "srcInitiatorId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentMethodsMetadataClickToPayMastercard from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentMethodsMetadataClickToPayMastercard from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "srciDpaId": obj.get("srciDpaId"),
            "srcInitiatorId": obj.get("srcInitiatorId")
        })
        return _obj
