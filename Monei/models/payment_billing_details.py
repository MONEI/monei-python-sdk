...
class PaymentBillingDetails(BaseModel):
    """
    Billing information associated with the payment method at the time of the transaction. 
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The customer's billing full name.")
    email: Optional[StrictStr] = Field(default=None, description="The customer's billing email address.")
    phone: Optional[StrictStr] = Field(default=None, description="The customer's billing phone number in E.164 format.")
    company: Optional[StrictStr] = Field(default=None, description="Billing company name.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentBillingDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentBillingDetails from a dict"""
        if obj is None:
            return None
