...
class PaymentMethodsMetadataApplePay(BaseModel):
    """
    PaymentMethodsMetadataApplePay
    """ # noqa: E501
    merchant_id: Optional[StrictStr] = Field(default=None, description="Apple Pay merchant ID", alias="merchantId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentMethodsMetadataApplePay from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentMethodsMetadataApplePay from a dict"""
        if obj is None:
            return None
