...
class PaymentSequence(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr
    recurring: Optional[PaymentSequenceRecurring] = None
    __properties: ClassVar[List[str]] = ["type", "recurring"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentSequence from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentSequence from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "recurring": PaymentSequenceRecurring.from_dict(obj["recurring"]) if obj.get("recurring") is not None else None
        })
        return _obj
