...
class SubscriptionPaymentMethodCard(BaseModel):
    """
    ...
    three_d_secure: Optional[StrictBool] = Field(default=None, description="Wether this transaction used 3D Secure authentication.", alias="threeDSecure")
    ...
    __properties: ClassVar[List[str]] = ["country", "brand", "type", "threeDSecure", "threeDSecureVersion", "expiration", "last4"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionPaymentMethodCard from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionPaymentMethodCard from a dict"""
        if obj is None:
            return None
