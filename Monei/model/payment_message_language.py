...
class PaymentMessageLanguage(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PaymentMessageLanguage - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The language of message sent to the customer. If not provided the default customer language is used if available.., must be one of ["en", "es", "ca", "pt", "de", "it", "fr", ]  # noqa: E501

        Keyword Args:
            value (str): The language of message sent to the customer. If not provided the default customer language is used if available.., must be one of ["en", "es", "ca", "pt", "de", "it", "fr", ]  # noqa: E501
