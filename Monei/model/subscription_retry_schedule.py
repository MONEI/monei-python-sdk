...
class SubscriptionRetrySchedule(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """SubscriptionRetrySchedule - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([SubscriptionRetryScheduleInner]): Defines a custom schedule for retrying failed subscription payments. Each entry in the array specifies how long to wait before attempting the next payment retry. If not specified, the system's default retry schedule will be used. .  # noqa: E501

        Keyword Args:
            value ([SubscriptionRetryScheduleInner]): Defines a custom schedule for retrying failed subscription payments. Each entry in the array specifies how long to wait before attempting the next payment retry. If not specified, the system's default retry schedule will be used. .  # noqa: E501
