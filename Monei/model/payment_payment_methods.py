...
class PaymentPaymentMethods(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([str]): An array of allowed payment methods (used in hosted payment page). Must be enabled payment methods. .  # noqa: E501

        Keyword Args:
            value ([str]): An array of allowed payment methods (used in hosted payment page). Must be enabled payment methods. .  # noqa: E501
