...
class RecurringPaymentRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, order_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            transaction_type (bool, date, datetime, dict, float, int, list, str, none_type): Same as the `transactionType` parameter from [create payment](https://docs.monei.com/apis/rest/payments-create/). If not sent, it will default in the same transaction type used in the initial payment. . [optional]  # noqa: E501
