...
class RecurringPaymentRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, order_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            amount (bool, date, datetime, dict, float, int, list, str, none_type): The amount to collected by this subsequent payment. A positive integer representing how much to charge in the smallest currency unit (e.g., 100 cents to charge 1.00 USD). . [optional]  # noqa: E501
            transaction_type (bool, date, datetime, dict, float, int, list, str, none_type): Same as the `transactionType` parameter from [create payment](https://docs.monei.com/api/#operation/payments_create). If not sent, it will default in the same transaction type used in the initial payment. . [optional]  # noqa: E501
