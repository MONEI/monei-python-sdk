...
class PaymentCancellationReason(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The reason for canceling the Payment.., must be one of ["duplicated", "fraudulent", "requested_by_customer", ]  # noqa: E501

        Keyword Args:
            value (str): The reason for canceling the Payment.., must be one of ["duplicated", "fraudulent", "requested_by_customer", ]  # noqa: E501
