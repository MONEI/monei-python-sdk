...
class PaymentCancellationReason(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PaymentCancellationReason - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The reason for canceling the Payment.., must be one of ["duplicated", "fraudulent", "requested_by_customer", "order_canceled", ]  # noqa: E501

        Keyword Args:
            value (str): The reason for canceling the Payment.., must be one of ["duplicated", "fraudulent", "requested_by_customer", "order_canceled", ]  # noqa: E501
