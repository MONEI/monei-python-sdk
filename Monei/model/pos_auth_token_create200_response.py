...
class PosAuthTokenCreate200Response(ModelNormal):
    ...
    def _from_openapi_data(cls, token, *args, **kwargs):  # noqa: E501
        """PosAuthTokenCreate200Response - a model defined in OpenAPI

        Args:
            token (str): RS256-signed JWT token for POS authentication. Valid for 24 hours.
