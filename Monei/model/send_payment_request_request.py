...
class SendPaymentRequestRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, phone_number, *args, **kwargs):  # noqa: E501
        """SendPaymentRequestRequest - a model defined in OpenAPI

        Args:
            phone_number (str): Phone number in E.164 format. The customer will receive payment link on this phone number.
