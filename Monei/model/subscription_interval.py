...
class SubscriptionInterval(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Subscription interval.., must be one of ["day", "week", "month", "year", ]  # noqa: E501

        Keyword Args:
            value (str): Subscription interval.., must be one of ["day", "week", "month", "year", ]  # noqa: E501
