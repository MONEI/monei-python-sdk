...
class SubscriptionInterval(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Subscription interval. The `minute` and `hour` intervals are only available in test mode.., must be one of ["minute", "hour", "day", "week", "month", "year", ]  # noqa: E501

        Keyword Args:
            value (str): Subscription interval. The `minute` and `hour` intervals are only available in test mode.., must be one of ["minute", "hour", "day", "week", "month", "year", ]  # noqa: E501
