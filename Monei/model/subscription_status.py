...
class SubscriptionStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The status of the subscription.., must be one of ["PENDING", "EXPIRED", "TRIALING", "ACTIVE", "PAST_DUE", "PAUSED", "CANCELED", ]  # noqa: E501

        Keyword Args:
            value (str): The status of the subscription.., must be one of ["PENDING", "EXPIRED", "TRIALING", "ACTIVE", "PAST_DUE", "PAUSED", "CANCELED", ]  # noqa: E501
