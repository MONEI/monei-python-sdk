...
class CreateSubscriptionRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, currency, interval, interval_count, callback_url, payment_callback_url, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            callback_url (str): The URL will be called each time subscription status changes. 
            payment_callback_url (str): The URL will be called each time subscription creates a new payments. 
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, currency, interval, interval_count, callback_url, payment_callback_url, *args, **kwargs):  # noqa: E501
        """CreateSubscriptionRequest - a model defined in OpenAPI
