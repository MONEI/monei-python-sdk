...
class PaymentSequenceRecurring(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PaymentSequenceRecurring - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            expiry (str): Date after which no further recurring payments will be performed. Must be formatted as `YYYYMMDD`. . [optional] if omitted the server will use the default value of "*(The payment method or card expiration)*"  # noqa: E501
