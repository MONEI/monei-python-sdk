...
class PaymentLastRefundReason(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The reason of the last refund transaction.., must be one of ["duplicated", "fraudulent", "requested_by_customer", ]  # noqa: E501

        Keyword Args:
            value (str): The reason of the last refund transaction.., must be one of ["duplicated", "fraudulent", "requested_by_customer", ]  # noqa: E501
