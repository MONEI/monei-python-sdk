...
class PaymentTransactionType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PaymentTransactionType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Controls when the funds will be captured. . if omitted defaults to "SALE", must be one of ["SALE", "AUTH", "PAYOUT", "VERIF", ]  # noqa: E501

        Keyword Args:
            value (str): Controls when the funds will be captured. . if omitted defaults to "SALE", must be one of ["SALE", "AUTH", "PAYOUT", "VERIF", ]  # noqa: E501
