...
class SubscriptionLastProration(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SubscriptionLastProration - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            credit (int): Unused time credited at the previous price, in the smallest currency unit. . [optional]  # noqa: E501
            charge (int): Time charged at the new price, in the smallest currency unit. An interval change charges the full new price rather than a fraction of it. . [optional]  # noqa: E501
            net (int): The settled difference, `charge` minus `credit`. A positive value was charged to the saved payment method. A negative value was refunded. . [optional]  # noqa: E501
            payment_id (bool, date, datetime, dict, float, int, list, str, none_type): The payment that funds the current period on top of its renewal, and the first source a later refund draws on. Set to the new payment when a prorated change charges. A change that refunds or moves no money keeps whichever payment an earlier prorated charge in this period created, since that money is still what funds the period. Absent when no prorated charge has funded the current period. . [optional]  # noqa: E501
        """
