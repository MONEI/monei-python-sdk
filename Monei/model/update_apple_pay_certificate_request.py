...
class UpdateApplePayCertificateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, active, *args, **kwargs):  # noqa: E501
        """UpdateApplePayCertificateRequest - a model defined in OpenAPI

        Args:
            active (bool): Set to true to enable or false to disable the certificate.
