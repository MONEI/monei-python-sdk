...
class PaymentMessageChannel(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The channel used to send the payment message. ., must be one of ["EMAIL", "WHATSAPP", "SMS", ]  # noqa: E501

        Keyword Args:
            value (str): The channel used to send the payment message. ., must be one of ["EMAIL", "WHATSAPP", "SMS", ]  # noqa: E501
