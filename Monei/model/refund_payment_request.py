...
class RefundPaymentRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            amount (bool, date, datetime, dict, float, int, list, str, none_type): The amount to refund, which must be less than or equal to the original amount. . [optional]  # noqa: E501
